...
const experience = [
  ...
  bullet('Pioneered LLM- and agent-based tooling, taking early prototypes through to production AI-enabled monitoring and debugging workflows that improved visibility into firmware systems.'),
